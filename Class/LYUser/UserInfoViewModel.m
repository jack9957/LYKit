...
- (instancetype)initWithCoder:(NSCoder *)coder
{
    ...
    if (self) {
        ...
        self.weichatToken = [coder decodeObjectForKey:@"weichatToken"];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.weichatToken forKey:@"weichatToken"];
}


- (NSString *)description
{
    return [self dictionaryWithValuesForKeys:@[@"u_id", @"nickName", @"phone", @"thumbImgUrl", @"originImgUrl",@"weichatToken"]].description;
}
